...
export function LuxmeterCalibrationForm({ data }: Props) {
  ...
  return (
    <div className="print-form p-4 max-w-[210mm] mx-auto text-[9px] leading-tight">
      <h1 className="text-center font-bold text-xs mb-2 uppercase tracking-wide">
        Registro de Calibração de Luxímetro
      </h1>
      ...
      <div className="mb-2">
        ...
        <table className="print-table text-[7px] w-full">
          <thead>
            <tr><th>Padrão (lux)</th><th>Leitura 1</th><th>Leitura 2</th><th>Leitura 3</th></tr>
          </thead>
          <tbody>
            {rows.map((_, i) => <tr key={i}><td className="h-4"></td><td></td><td></td><td></td></tr>)}
          </tbody>
        </table>
      </div>
