...
export function TemperatureHumidityCalibrationForm({ data }: Props) {
  ...
  return (
    <div className="print-form p-4 max-w-[210mm] mx-auto text-[9px] leading-tight">
      <h1 className="text-center font-bold text-xs mb-2 uppercase tracking-wide">
        Registro de Calibração de Temperatura e Umidade
      </h1>
      ...
      <div className="mb-2">
        ...
        <table className="print-table text-[7px] w-full">
          <thead>
            <tr>
              <th rowSpan={2}>Padrão</th>
              <th colSpan={2}>Sensor</th>
              <th colSpan={3}>Sem Ajuste</th>
              <th colSpan={3}>Após Ajuste</th>
            </tr>
            <tr>
              <th>( ) Temperatura</th>
              <th>( ) Umidade</th>
      ...
      <div className="mb-1">
        ...
        <div className="grid grid-cols-3 gap-x-2 text-[7px]">
          {["IP 01 - Cappo","IP 02 - Forno Calibração","IP 27 - Termômetro Digital","IP 58 - Termorresistência Pt-100","IP 68 - Termo-Higrômetro Digital","IP 108 - Forno Presys"].map(p => (
